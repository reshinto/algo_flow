...
> [!NOTE] > **Prerequisites:** Familiarity with TypeScript, React, and Git. See the [Glossary](glossary.md) for AlgoFlow-specific terms like Registry, Tracker, and ExecutionStep.
...
| Trees (traversal)    | `TreeTracker`               | `initialize`, `visit`, `traverse`, `complete`                                                                                                                                                                                          |
| Trees (BST ops)      | `BSTOperationTracker`       | `initialize`, `search`, `insert`, `delete`, `validate`, `complete`                                                                                                                                                                     |
| Trees (properties)   | `TreePropertyTracker`       | `initialize`, `computeDepth`, `checkBalance`, `checkSymmetry`, `tracePath`, `complete`                                                                                                                                                 |
| Trees (construction) | `TreeConstructionTracker`   | `initialize`, `placeNode`, `linkChild`, `deserialize`, `complete`                                                                                                                                                                      |
| Trees (manipulation) | `TreeManipulationTracker`   | `initialize`, `invertNodes`, `flattenNode`, `mergeNodes`, `findAncestor`, `complete`                                                                                                                                                   |
| Trees (advanced)     | `AdvancedTreeTracker`       | `initialize`, `rotate`, `recolor`, `buildSegment`, `queryRange`, `encode`, `complete`                                                                                                                                                  |
