/**
 * Storybook stories for the Naive Pattern Search algorithm pipeline.
...
const meta: Meta<typeof StringVisualizer> = {
  title: "Algorithm Pipelines/Naive Pattern Search",
...
/** Initial state — pattern aligned at offset 0, no comparisons made yet */
...
/** Early search — pattern partially matched or mismatched at first position */
export const EarlySearch: Story = {
  args: {
    visualState: steps[Math.floor(steps.length * 0.25)]!.visualState as StringVisualState,
  },
};

/** Mid-search — pattern window partway through the text */
