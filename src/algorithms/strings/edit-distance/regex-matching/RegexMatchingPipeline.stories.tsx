/**
 * Storybook stories for the Regular Expression Matching algorithm pipeline.
...
const steps = generateRegexMatchingSteps({
  text: "aab",
  pattern: "c*a*b",
});

const meta: Meta<typeof DistanceVisualizer> = {
  title: "Algorithm Pipelines/Regular Expression Matching",
...
/** Base cases filled — row 0 populated with star-pair propagation for empty text */
