...
import rustSource from "./sources/majority-element.rs?raw";
import cppSource from "./sources/MajorityElement.cpp?raw";
import goSource from "./sources/majority-element.go?raw";
