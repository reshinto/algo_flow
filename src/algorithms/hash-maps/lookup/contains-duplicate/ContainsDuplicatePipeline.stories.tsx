/**
 * Storybook stories for the Contains Duplicate algorithm pipeline.
 * Uses the real step generator with the default input [1, 2, 3, 1],
...
const meta: Meta<typeof HashMapVisualizer> = {
  title: "Algorithm Pipelines/Contains Duplicate",
...
/** Initial state — empty hash set, first element about to be processed */
...
/** Mid-execution — some elements inserted, checking for duplicate */
...
/** Final state — duplicate found, result highlighted */
