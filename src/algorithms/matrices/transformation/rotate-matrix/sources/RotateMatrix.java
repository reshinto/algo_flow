...
public class RotateMatrix {
    ...
    public static int[][] rotateMatrix(int[][] matrix) {
        ...
        for (int rowIdx = 0; rowIdx < matrixSize; rowIdx++) { // @step:swap-cells
            for (int colIdx = rowIdx + 1; colIdx < matrixSize; colIdx++) { // @step:swap-cells
        ...
        for (int rowIdx = 0; rowIdx < matrixSize; rowIdx++) { // @step:swap-cells
            ...
            while (leftCol < rightCol) { // @step:swap-cells
