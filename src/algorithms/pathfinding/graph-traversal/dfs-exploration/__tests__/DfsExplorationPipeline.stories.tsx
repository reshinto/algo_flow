/**
 * Storybook stories for the DFS Exploration pipeline.
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/DfsExploration",
...
/** Mid-exploration with deep-first snaking pattern visible */
...
/** Exploration complete — all reachable cells visited via DFS */
