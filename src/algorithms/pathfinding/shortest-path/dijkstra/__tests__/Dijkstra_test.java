// javac Dijkstra.java Dijkstra_test.java && java -ea Dijkstra_test
public class Dijkstra_test {
    ...
    public static void main(String[] args) {
        // Test: finds path
        {
            ...
            int[][] path = Dijkstra.dijkstra(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: path empty when blocked
        {
            ...
            int[][] path = Dijkstra.dijkstra(grid, new int[]{0, 0}, new int[]{2, 2});
        ...
        {
            int[][] grid = makeGrid(3, 3);
            int[][] path = Dijkstra.dijkstra(grid, new int[]{0, 0}, new int[]{0, 1});
