...
bfs_shortest_path_mod = importlib.import_module("bfs-shortest-path")
bfs_shortest_path = bfs_shortest_path_mod.bfs_shortest_path
...
def test_path_empty_when_blocked():
    ...
    result = bfs_shortest_path(grid, (0, 0), (2, 2))
    assert len(result["path"]) == 0
...
def test_adjacent_cells():
    ...
    grid[0][0]["type"] = "start"
    grid[0][1]["type"] = "end"
    result = bfs_shortest_path(grid, (0, 0), (0, 1))
