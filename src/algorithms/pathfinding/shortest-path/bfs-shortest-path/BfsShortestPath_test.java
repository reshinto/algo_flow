// javac BfsShortestPath.java BfsShortestPath_test.java && java -ea BfsShortestPath_test
public class BfsShortestPath_test {
    ...
    public static void main(String[] args) {
        // Test: finds path
        {
            ...
            int[][] path = BfsShortestPath.bfsShortestPath(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: path empty when blocked
        {
            ...
            int[][] path = BfsShortestPath.bfsShortestPath(grid, new int[]{0, 0}, new int[]{2, 2});
        ...
        {
            int[][] grid = makeGrid(3, 3);
            int[][] path = BfsShortestPath.bfsShortestPath(grid, new int[]{0, 0}, new int[]{0, 1});
