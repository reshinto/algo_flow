include!("../sources/bfs-shortest-path.rs");
...
mod tests {
    ...
    fn finds_path() {
        ...
        let result = bfs_shortest_path(&grid, (0, 0), (4, 4));
    ...
    fn path_empty_when_blocked() {
        ...
        let result = bfs_shortest_path(&grid, (0, 0), (2, 2));
        assert!(result.path.is_empty());
    }
    ...
    fn adjacent_cells() {
        ...
        let result = bfs_shortest_path(&grid, (0, 0), (0, 1));
