...
dijkstra_bidirectional_mod = importlib.import_module("dijkstra-bidirectional")
dijkstra_bidirectional = dijkstra_bidirectional_mod.dijkstra_bidirectional
...
def test_finds_path():
    ...
    grid[0][0]["type"] = "start"
    grid[4][4]["type"] = "end"
    result = dijkstra_bidirectional(grid, (0, 0), (4, 4))
...
def test_path_empty_when_blocked():
    ...
    result = dijkstra_bidirectional(grid, (0, 0), (2, 2))
    assert len(result["path"]) == 0
...
def test_adjacent_cells():
    ...
    grid[0][0]["type"] = "start"
    grid[0][1]["type"] = "end"
    result = dijkstra_bidirectional(grid, (0, 0), (0, 1))
