/**
 * Storybook stories for the Dijkstra Bidirectional pipeline.
...
const steps = generateDijkstraBidirectionalSteps({
  grid: storyGrid,
  startPosition,
  endPosition,
});
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/DijkstraBidirectional",
...
/** Initial grid state before both searches begin */
...
/** Mid-search with forward (blue) and reverse (purple) frontiers expanding toward each other */
...
/** Path found — two frontiers met and the full path is highlighted */
