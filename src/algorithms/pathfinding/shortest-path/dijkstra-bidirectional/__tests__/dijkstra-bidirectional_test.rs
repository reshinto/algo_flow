include!("../sources/dijkstra-bidirectional.rs");
...
mod tests {
    ...
    fn finds_path() {
        ...
        let result = dijkstra_bidirectional(&grid, (0, 0), (4, 4));
    ...
    fn path_empty_when_blocked() {
        ...
        let result = dijkstra_bidirectional(&grid, (0, 0), (2, 2));
        assert!(result.path.is_empty());
    }
    ...
    fn adjacent_cells() {
        ...
        let result = dijkstra_bidirectional(&grid, (0, 0), (0, 1));
