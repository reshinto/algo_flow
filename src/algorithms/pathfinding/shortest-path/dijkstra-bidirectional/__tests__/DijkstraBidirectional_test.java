// javac DijkstraBidirectional.java DijkstraBidirectional_test.java && java -ea DijkstraBidirectional_test
public class DijkstraBidirectional_test {
    ...
    public static void main(String[] args) {
        // Test: finds path
        {
            ...
            int[][] path = DijkstraBidirectional.dijkstraBidirectional(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: path empty when blocked
        {
            ...
            int[][] path = DijkstraBidirectional.dijkstraBidirectional(grid, new int[]{0, 0}, new int[]{2, 2});
        ...
        {
            int[][] grid = makeGrid(3, 3);
            int[][] path = DijkstraBidirectional.dijkstraBidirectional(grid, new int[]{0, 0}, new int[]{0, 1});
