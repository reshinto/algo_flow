...
describe("dijkstraBidirectional", () => {
  ...
  it("navigates around walls", () => {
    ...
    const result = dijkstraBidirectional(grid, [0, 0], [0, 4]);
  ...
  it("handles adjacent start and end", () => {
    ...
    const result = dijkstraBidirectional(grid, [0, 0], [0, 1]);
  ...
  it("handles start equal to end", () => {
    ...
    const result = dijkstraBidirectional(grid, [1, 1], [1, 1]);
  ...
  it("tracks visited cells", () => {
    ...
    const result = dijkstraBidirectional(grid, [0, 0], [2, 2]);
