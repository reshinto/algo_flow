// javac AStarGrid.java AStarGrid_test.java && java -ea AStarGrid_test
public class AStarGrid_test {
    ...
    public static void main(String[] args) {
        // Test: finds path
        {
            ...
            int[][] path = AStarGrid.aStarGrid(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: path empty when blocked
        {
            ...
            int[][] path = AStarGrid.aStarGrid(grid, new int[]{0, 0}, new int[]{2, 2});
        ...
        {
            int[][] grid = makeGrid(3, 3);
            int[][] path = AStarGrid.aStarGrid(grid, new int[]{0, 0}, new int[]{0, 1});
