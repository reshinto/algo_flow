...
describe("aStarGrid", () => {
  it("finds a direct path on an empty grid", () => {
    ...
    const result = aStarGrid(grid, [0, 0], [4, 4]);
  ...
  it("navigates around walls", () => {
    ...
    const result = aStarGrid(grid, [0, 0], [0, 4]);
  ...
  it("handles adjacent start and end", () => {
    ...
    const result = aStarGrid(grid, [0, 0], [0, 1]);
  ...
  it("handles start equal to end", () => {
    ...
    const result = aStarGrid(grid, [1, 1], [1, 1]);
  ...
  it("tracks visited cells", () => {
    ...
    const result = aStarGrid(grid, [0, 0], [2, 2]);
