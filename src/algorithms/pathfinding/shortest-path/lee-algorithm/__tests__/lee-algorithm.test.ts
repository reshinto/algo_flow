...
describe("leeAlgorithm", () => {
  ...
  it("navigates around walls", () => {
    ...
    const result = leeAlgorithm(grid, [0, 0], [0, 4]);
  ...
  it("handles adjacent start and end", () => {
    ...
    const result = leeAlgorithm(grid, [0, 0], [0, 1]);
  ...
  it("handles start equal to end", () => {
    ...
    const result = leeAlgorithm(grid, [1, 1], [1, 1]);
  ...
  it("tracks visited cells", () => {
    ...
    const result = leeAlgorithm(grid, [0, 0], [2, 2]);
