/**
 * Storybook stories for the Lee Algorithm pipeline.
...
const steps = generateLeeAlgorithmSteps({
  grid: storyGrid,
  startPosition,
  endPosition,
});
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/LeeAlgorithm",
...
/** Initial grid state before wavefront expansion */
...
/** Mid-expansion with wave numbers spreading across the grid */
...
/** Path found — shortest route highlighted via wave-number backtracking */
