/**
 * Storybook stories for the Bellman-Ford Grid pipeline.
...
const steps = generateBellmanFordGridSteps({
  grid: storyGrid,
  startPosition,
  endPosition,
});
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/BellmanFordGrid",
...
/** Initial grid state before relaxation begins */
...
/** Mid-relaxation with distance costs propagating across the grid */
