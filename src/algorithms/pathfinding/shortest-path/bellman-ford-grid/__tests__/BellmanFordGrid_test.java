// javac BellmanFordGrid.java BellmanFordGrid_test.java && java -ea BellmanFordGrid_test
public class BellmanFordGrid_test {
    ...
    public static void main(String[] args) {
        // Test: finds path
        {
            ...
            int[][] path = BellmanFordGrid.bellmanFordGrid(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: path empty when blocked
        {
            ...
            int[][] path = BellmanFordGrid.bellmanFordGrid(grid, new int[]{0, 0}, new int[]{2, 2});
        ...
        {
            int[][] grid = makeGrid(3, 3);
            int[][] path = BellmanFordGrid.bellmanFordGrid(grid, new int[]{0, 0}, new int[]{0, 1});
