include!("../sources/bellman-ford-grid.rs");
...
mod tests {
    ...
    fn finds_path() {
        ...
        let result = bellman_ford_grid(&grid, (0, 0), (4, 4));
    ...
    fn path_empty_when_blocked() {
        ...
        let result = bellman_ford_grid(&grid, (0, 0), (2, 2));
        assert!(result.path.is_empty());
    }
    ...
    fn adjacent_cells() {
        ...
        let result = bellman_ford_grid(&grid, (0, 0), (0, 1));
