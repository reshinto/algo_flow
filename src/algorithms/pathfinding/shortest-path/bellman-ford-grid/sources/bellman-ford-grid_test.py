...
bellman_ford_grid_mod = importlib.import_module("bellman-ford-grid")
bellman_ford_grid = bellman_ford_grid_mod.bellman_ford_grid
...
def test_finds_path():
    ...
    grid[0][0]["type"] = "start"
    grid[4][4]["type"] = "end"
    result = bellman_ford_grid(grid, (0, 0), (4, 4))
...
def test_path_empty_when_blocked():
    ...
    result = bellman_ford_grid(grid, (0, 0), (2, 2))
    assert len(result["path"]) == 0
...
def test_adjacent_cells():
    ...
    grid[0][0]["type"] = "start"
    grid[0][1]["type"] = "end"
    result = bellman_ford_grid(grid, (0, 0), (0, 1))
