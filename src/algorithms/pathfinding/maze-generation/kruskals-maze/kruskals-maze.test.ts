...
describe("kruskalsMaze", () => {
  ...
  it("carves all odd-indexed passage cells", () => {
    ...
    // All odd-indexed cells should be empty (carved as passage cells)
  ...
  it("returns passages carved count greater than zero", () => {
