/**
 * Storybook stories for the Prim's Maze pipeline.
...
/** Build a small all-walls grid for the Prim's maze story */
...
const steps = generatePrimsMazeSteps({
  grid: storyGrid,
  startPosition,
  endPosition,
});
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/PrimsMaze",
...
/** Initial all-walls grid before Prim's frontier begins */
...
/** Mid-generation with frontier cells highlighted in orange */
...
/** Completed maze — bushy branchy structure typical of Prim's */
