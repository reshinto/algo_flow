...
// javac RecursiveBacktracker.java RecursiveBacktracker_test.java && java -ea RecursiveBacktracker_test
public class RecursiveBacktracker_test {
    ...
    public static void main(String[] args) {
        // Test: carves passages
        {
            ...
            grid[1][1] = 0;
            int passagesCarved = RecursiveBacktracker.recursiveBacktrackerMaze(grid, new int[]{1, 1});
        ...
        // Test: creates connected maze
        {
            ...
            grid[1][1] = 0;
            grid[7][7] = 0;
            RecursiveBacktracker.recursiveBacktrackerMaze(grid, new int[]{1, 1});
