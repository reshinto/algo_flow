...
recursive_backtracker_mod = importlib.import_module("recursive-backtracker")
recursive_backtracker_maze = recursive_backtracker_mod.recursive_backtracker_maze
...
def test_carves_passages():
    ...
    grid[1][1]["type"] = "start"
    result = recursive_backtracker_maze(grid, (1, 1))
...
def test_creates_connected_maze():
    ...
    grid[1][1]["type"] = "start"
    grid[7][7]["type"] = "end"
    recursive_backtracker_maze(grid, (1, 1))
