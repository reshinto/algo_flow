/**
 * Storybook stories for the Recursive Backtracker Maze pipeline.
...
const steps = generateRecursiveBacktrackerSteps({
  grid: storyGrid,
  startPosition,
  endPosition,
});
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/RecursiveBacktracker",
...
/** Initial all-walls grid before any carving begins */
...
/** Mid-generation with carved passages radiating from the start */
...
/** Completed maze — all passages carved with long winding corridors */
