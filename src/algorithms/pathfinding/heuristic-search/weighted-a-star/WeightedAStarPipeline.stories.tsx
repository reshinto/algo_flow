/**
 * Storybook stories for the Weighted A* pipeline.
...
const steps = generateWeightedAStarSteps({
  grid: storyGrid,
  startPosition,
  endPosition,
  weight: 1.5,
...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/WeightedAStar",
...
/** Mid-exploration — inflated heuristic pulling search toward the goal */
...
/** Path found — route highlighted, fewer nodes explored than standard A* */
