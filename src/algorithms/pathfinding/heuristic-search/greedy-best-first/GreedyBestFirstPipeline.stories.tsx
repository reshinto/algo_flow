/**
 * Storybook stories for the Greedy Best-First Search pipeline.
...
const steps = generateGreedyBestFirstSteps({ grid: storyGrid, startPosition, endPosition });

const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/GreedyBestFirst",
...
/** Mid-exploration — greedy search rushing toward the goal */
...
/** Path found — route highlighted from start to end */
