// javac GreedyBestFirst.java GreedyBestFirst_test.java && java -ea GreedyBestFirst_test
public class GreedyBestFirst_test {
    ...
    public static void main(String[] args) {
        // Test: finds path on empty grid
        {
            ...
            int[][] path = GreedyBestFirst.greedyBestFirst(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: handles adjacent start and end
        {
            ...
            int[][] path = GreedyBestFirst.greedyBestFirst(grid, new int[]{0, 0}, new int[]{0, 1});
        ...
        {
            int[][] grid = makeEmptyGrid(3, 3);
            int[][] path = GreedyBestFirst.greedyBestFirst(grid, new int[]{1, 1}, new int[]{1, 1});
