...
const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/IDAStar",
...
/** Mid-search — DFS exploring within the current f-cost threshold */
...
/** Path found — optimal route highlighted after threshold convergence */
