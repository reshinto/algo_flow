...
describe("idaStar", () => {
  it("finds a path on an empty grid", () => {
    ...
    const result = idaStar(grid, [0, 0], [4, 4]);
  ...
  it("finds optimal path length", () => {
    ...
    /* Manhattan distance = 8, path has 9 cells including both endpoints */
  ...
  it("navigates around a wall barrier", () => {
    ...
    const result = idaStar(grid, [0, 0], [0, 4]);
  ...
  it("handles adjacent start and end", () => {
    ...
    const result = idaStar(grid, [0, 0], [0, 1]);
  ...
  it("handles start equal to end", () => {
    ...
    const result = idaStar(grid, [1, 1], [1, 1]);
  ...
  it("records iteration count", () => {
    ...
    const result = idaStar(grid, [0, 0], [3, 3]);
  ...
  it("tracks visited cells", () => {
    ...
    const result = idaStar(grid, [0, 0], [2, 2]);
