...
mod tests {
    ...
    fn finds_path_on_empty_grid() {
        ...
        let result = ida_star(&grid, (0, 0), (4, 4));
    ...
    fn handles_adjacent_start_and_end() {
        ...
        let result = ida_star(&grid, (0, 0), (0, 1));
    ...
    fn handles_start_equal_to_end() {
        let grid = make_empty_grid(3, 3);
        let result = ida_star(&grid, (1, 1), (1, 1));
        assert_eq!(result.path.len(), 1);
        assert_eq!(result.path[0], (1, 1));
    }

    #[test]
    fn records_iteration_count() {
        let grid = make_empty_grid(4, 4);
        let result = ida_star(&grid, (0, 0), (3, 3));
