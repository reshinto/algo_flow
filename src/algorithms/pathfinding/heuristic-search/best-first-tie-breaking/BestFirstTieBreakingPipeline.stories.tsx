/**
 * Storybook stories for the Best-First Tie Breaking A* pipeline.
...
const steps = generateBestFirstTieBreakingSteps({ grid: storyGrid, startPosition, endPosition });

const meta: Meta<typeof GridVisualizer> = {
  title: "Algorithm Pipelines/BestFirstTieBreaking",
...
/** Mid-exploration — straight-line preference guiding node selection */
...
/** Path found — straight, aesthetically clean route highlighted */
