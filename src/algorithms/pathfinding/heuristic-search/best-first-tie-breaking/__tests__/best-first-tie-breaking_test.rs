include!("../sources/best-first-tie-breaking.rs");
...
mod tests {
    ...
    fn finds_path_on_empty_grid() {
        ...
        let result = best_first_tie_breaking(&grid, (0, 0), (4, 4));
    ...
    fn handles_adjacent_start_and_end() {
        ...
        let result = best_first_tie_breaking(&grid, (0, 0), (0, 1));
    ...
    fn handles_start_equal_to_end() {
        let grid = make_empty_grid(3, 3);
        let result = best_first_tie_breaking(&grid, (1, 1), (1, 1));
    ...
    fn tracks_visited_cells() {
        let grid = make_empty_grid(3, 3);
        let result = best_first_tie_breaking(&grid, (0, 0), (2, 2));
