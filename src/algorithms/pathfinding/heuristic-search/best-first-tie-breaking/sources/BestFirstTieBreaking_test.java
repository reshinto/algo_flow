// javac BestFirstTieBreaking.java BestFirstTieBreaking_test.java && java -ea BestFirstTieBreaking_test
public class BestFirstTieBreaking_test {
    ...
    public static void main(String[] args) {
        // Test: finds path on empty grid
        {
            ...
            int[][] path = BestFirstTieBreaking.bestFirstTieBreaking(grid, new int[]{0, 0}, new int[]{4, 4});
        ...
        // Test: handles adjacent start and end
        {
            ...
            int[][] path = BestFirstTieBreaking.bestFirstTieBreaking(grid, new int[]{0, 0}, new int[]{0, 1});
        ...
        {
            int[][] grid = makeEmptyGrid(3, 3);
            int[][] path = BestFirstTieBreaking.bestFirstTieBreaking(grid, new int[]{1, 1}, new int[]{1, 1});
