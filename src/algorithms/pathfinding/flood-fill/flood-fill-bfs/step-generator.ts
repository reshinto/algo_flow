/** Step generator for Flood Fill BFS — produces ExecutionStep[] using PathfindingTracker. */
...
const FLOOD_FILL_BFS_LINE_MAP = buildLineMapFromSources(ALGORITHM_ID.FLOOD_FILL_BFS!);
...
export function generateFloodFillBfsSteps(input: FloodFillBfsInput): ExecutionStep[] {
