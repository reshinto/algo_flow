/**
 * Storybook stories for the Smooth Sort algorithm pipeline.
...
const steps = generateSmoothSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Smooth Sort",
...
/** Initial state before any heap operations occur */
...
/** Mid-execution showing Leonardo heap build phase */
