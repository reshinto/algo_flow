public class SelectionSort_test {
    public static void main(String[] args) {
        assert java.util.Arrays.equals(
            SelectionSort.selectionSort(new int[]{64, 34, 25, 12, 22, 11, 90}),
            new int[]{11, 12, 22, 25, 34, 64, 90}
        ) : "Test failed: sorts an unsorted array";

        assert java.util.Arrays.equals(
            SelectionSort.selectionSort(new int[]{1, 2, 3, 4, 5}),
            new int[]{1, 2, 3, 4, 5}
        ...
        assert java.util.Arrays.equals(
            SelectionSort.selectionSort(new int[]{3, 1, 4, 1, 5, 9, 2, 6, 5}),
            new int[]{1, 1, 2, 3, 4, 5, 5, 6, 9}
        ) : "Test failed: handles an array with duplicate values";

        assert java.util.Arrays.equals(
            SelectionSort.selectionSort(new int[]{42}),
            new int[]{42}
        ...
        assert java.util.Arrays.equals(
            SelectionSort.selectionSort(new int[]{3, -1, 0, -5, 2}),
            new int[]{-5, -1, 0, 2, 3}
        ) : "Test failed: handles an array with negative numbers";

        int[] original = new int[]{3, 1, 2};
        int[] sorted = SelectionSort.selectionSort(original);
