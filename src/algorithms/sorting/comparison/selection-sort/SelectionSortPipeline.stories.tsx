/**
 * Storybook stories for the Selection Sort algorithm pipeline.
...
const steps = generateSelectionSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Selection Sort",
