public class HeapSort_test {
    public static void main(String[] args) {
        assert java.util.Arrays.equals(
            HeapSort.heapSort(new int[]{64, 34, 25, 12, 22, 11, 90}),
        ...
        assert java.util.Arrays.equals(
            HeapSort.heapSort(new int[]{3, 1, 4, 1, 5, 9, 2, 6, 5}),
