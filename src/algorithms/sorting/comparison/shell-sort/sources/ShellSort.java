public class ShellSort {
    public static int[] shellSort(int[] inputArray) { // @step:initialize
        ...
        for (int gapSize = arrayLength / 2; gapSize > 0; gapSize /= 2) { // @step:gap-update

            // Perform a gapped insertion sort for this gap size
            for (int outerIndex = gapSize; outerIndex < arrayLength; outerIndex++) { // @step:compare
                ...
                while (innerIndex >= gapSize && sortedArray[innerIndex - gapSize] > currentValue) { // @step:compare
