public class MergeSort_test {
    public static void main(String[] args) {
        assert java.util.Arrays.equals(
            MergeSort.mergeSort(new int[]{64, 34, 25, 12, 22, 11, 90}),
        ...
        assert java.util.Arrays.equals(
            MergeSort.mergeSort(new int[]{3, 1, 4, 1, 5, 9, 2, 6, 5}),
            new int[]{1, 1, 2, 3, 4, 5, 5, 6, 9}
        ) : "Test failed: handles an array with duplicate values";

        assert java.util.Arrays.equals(
            MergeSort.mergeSort(new int[]{42}),
            new int[]{42}
        ...
        assert java.util.Arrays.equals(
            MergeSort.mergeSort(new int[]{3, -1, 0, -5, 2}),
            new int[]{-5, -1, 0, 2, 3}
        ) : "Test failed: handles an array with negative numbers";

        int[] original = new int[]{3, 1, 2};
        int[] sorted = MergeSort.mergeSort(original);
