/**
 * Storybook stories for the Tournament Sort algorithm pipeline.
...
const steps = generateTournamentSortSteps([4, 2, 7, 1, 5, 3, 6]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Tournament Sort",
...
/** Initial state before tournament tree is built */
...
/** Mid-execution with winners being extracted */
