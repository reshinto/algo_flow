public class BlockSort_test {
    public static void main(String[] args) {
        ...
        assert java.util.Arrays.equals(
            BlockSort.blockSort(new int[]{2, 1}),
            new int[]{1, 2}
        ) : "Test failed: handles a two element array";

        // handles an array with multiple natural runs
        assert java.util.Arrays.equals(
            BlockSort.blockSort(new int[]{1, 3, 5, 2, 4, 6, 0, 7}),
            new int[]{0, 1, 2, 3, 4, 5, 6, 7}
        ) : "Test failed: handles an array with multiple natural runs";
