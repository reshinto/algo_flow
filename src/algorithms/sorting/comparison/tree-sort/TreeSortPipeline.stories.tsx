/**
 * Storybook stories for the Tree Sort algorithm pipeline.
...
const steps = generateTreeSortSteps([5, 3, 7, 1, 4, 6, 2]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Tree Sort",
...
/** Initial state before any BST insertions occur */
...
/** Mid-execution with BST partially built */
...
/** Final state with all elements fully sorted via inorder traversal */
