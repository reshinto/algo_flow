public class PatienceSort_test {
    public static void main(String[] args) {
        ...
        assert java.util.Arrays.equals(
            PatienceSort.patienceSort(new int[]{64, 34, 25, 12, 22, 11, 90, 55, 47, 8}),
