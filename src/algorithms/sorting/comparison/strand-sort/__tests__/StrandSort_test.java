public class StrandSort_test {
    public static void main(String[] args) {
        ...
        assert java.util.Arrays.equals(
            StrandSort.strandSort(new int[]{2, 1}),
            new int[]{1, 2}
        ) : "Test failed: handles a two element array";

        assert java.util.Arrays.equals(
            StrandSort.strandSort(new int[]{3, 1, 4, 2, 5}),
            new int[]{1, 2, 3, 4, 5}
        ) : "Test failed: extracts multiple strands";
