/**
 * Storybook stories for the Strand Sort algorithm pipeline.
...
const steps = generateStrandSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Strand Sort",
...
/** Initial state before any strand extraction */
...
/** Mid-execution showing strand extraction and merging */
