/**
 * Storybook stories for the Flash Sort algorithm pipeline.
...
const steps = generateFlashSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Flash Sort",
...
/** Initial state before any classification occurs */
...
/** Mid-execution with active classification and permutation */
