/**
 * Storybook stories for the Counting Sort (Distribution) algorithm pipeline.
...
const steps = generateCountingSortSteps([64, 34, 25, 12, 22, 11, 90]);
...
/** Initial state before any counting occurs */
...
/** Mid-execution showing elements being counted and placed */
