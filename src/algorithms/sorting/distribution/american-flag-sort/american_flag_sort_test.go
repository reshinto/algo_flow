...
func TestSortsUnsortedArray(t *testing.T) {
	result := americanFlagSort([]int{64, 34, 25, 12, 22, 11, 90})
...
func TestHandlesAlreadySortedArray(t *testing.T) {
	result := americanFlagSort([]int{1, 2, 3, 4, 5})
...
func TestHandlesReverseSortedArray(t *testing.T) {
	result := americanFlagSort([]int{5, 4, 3, 2, 1})
	expected := []int{1, 2, 3, 4, 5}
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("expected %v, got %v", expected, result)
	}
...
func TestHandlesArrayWithDuplicateValues(t *testing.T) {
	result := americanFlagSort([]int{3, 1, 4, 1, 5, 9, 2, 6, 5})
...
func TestHandlesSingleElementArray(t *testing.T) {
	result := americanFlagSort([]int{42})
	expected := []int{42}
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("expected %v, got %v", expected, result)
	}
...
func TestHandlesEmptyArray(t *testing.T) {
	result := americanFlagSort([]int{})
	if len(result) != 0 {
		t.Errorf("expected empty slice, got %v", result)
	}
}

func TestHandlesAllIdenticalElements(t *testing.T) {
	result := americanFlagSort([]int{7, 7, 7, 7})
...
func TestHandlesNegativeNumbers(t *testing.T) {
	result := americanFlagSort([]int{3, -1, 0, -5, 2})
...
func TestHandlesLargeNumbers(t *testing.T) {
	result := americanFlagSort([]int{100, 999, 500, 1, 750})
	expected := []int{1, 100, 500, 750, 999}
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("expected %v, got %v", expected, result)
	}
}
...
func TestDoesNotMutateOriginalArray(t *testing.T) {
	...
	sorted := americanFlagSort(original)
