/**
 * Storybook stories for the Bucket Sort algorithm pipeline.
...
const steps = generateBucketSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Bucket Sort",
...
/** Mid-execution showing elements distributed into buckets and being sorted */
