/**
 * Storybook stories for the Pigeonhole Sort algorithm pipeline.
...
const steps = generatePigeonholeSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Pigeonhole Sort",
...
/** Initial state before any placement occurs */
...
/** Mid-execution showing elements placed in pigeonholes and being collected */
