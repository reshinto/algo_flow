/**
 * Storybook stories for the Radix Sort LSD algorithm pipeline.
...
const steps = generateRadixSortLsdSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Radix Sort LSD",
...
/** Initial state before any digit passes */
...
/** Mid-execution showing digit extraction and bucket collection */
