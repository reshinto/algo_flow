/**
 * Storybook stories for the Radix Sort MSD algorithm pipeline.
...
const steps = generateRadixSortMsdSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Radix Sort MSD",
...
/** Mid-execution showing recursive MSD partitioning */
