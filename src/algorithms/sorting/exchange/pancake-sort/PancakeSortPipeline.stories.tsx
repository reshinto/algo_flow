/**
 * Storybook stories for the Pancake Sort algorithm pipeline.
...
const steps = generatePancakeSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Pancake Sort",
