/**
 * Storybook stories for the Pairwise Sorting Network algorithm pipeline.
 */
...
const steps = generatePairwiseSortingNetworkSteps([5, 3, 8, 1, 4, 2, 7, 6]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Pairwise Sorting Network",
