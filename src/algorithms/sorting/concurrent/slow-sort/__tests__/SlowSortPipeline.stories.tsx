/**
 * Storybook stories for the Slow Sort algorithm pipeline.
 */
...
const steps = generateSlowSortSteps([5, 3, 1, 4, 2]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Slow Sort",
...
/** Mid-execution showing recursive maximum-finding */
