/**
 * Storybook stories for the Block Merge Sort algorithm pipeline.
...
const steps = generateBlockMergeSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Block Merge Sort",
...
/** Initial state before run detection and merging begins */
