/**
 * Storybook stories for the Dual-Pivot Quick Sort algorithm pipeline.
...
const steps = generateDualPivotQuickSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Dual-Pivot Quick Sort",
...
/** Initial state before any dual-pivot partitioning occurs */
...
/** Mid-execution showing three-partition structure */
