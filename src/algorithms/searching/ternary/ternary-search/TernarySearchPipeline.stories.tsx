/**
 * Storybook stories for the Ternary Search algorithm pipeline.
...
const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Ternary Search",
...
/** Initial state with full search range and two midpoints visible */
