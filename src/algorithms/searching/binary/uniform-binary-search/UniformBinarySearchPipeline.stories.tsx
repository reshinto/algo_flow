/**
 * Storybook stories for the Uniform Binary Search algorithm pipeline.
 * Uses the real step generator with a pre-computed delta table approach,
...
const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Uniform Binary Search",
...
/** Initial state with delta table computed and search starting at midpoint */
...
/** Mid-search state with some delta steps completed */
