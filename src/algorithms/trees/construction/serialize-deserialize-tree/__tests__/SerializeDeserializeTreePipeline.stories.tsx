/**
 * Storybook stories for the Serialize & Deserialize Binary Tree pipeline.
 * Uses the real step generator with a balanced 7-node BST,
 * rendering the TreeVisualizer at key states (serialize then deserialize phases).
 */
...
const steps = generateSerializeDeserializeTreeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Serialize & Deserialize Binary Tree",
...
/** Initial state — tree before serialization begins */
...
/** Mid-construction — during deserialization phase */
...
/** Construction complete — tree fully deserialized */
