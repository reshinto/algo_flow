/**
 * Storybook stories for the Build Tree from Postorder + Inorder (Iterative) pipeline.
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Build Tree: Postorder + Inorder (Iterative)",
...
/** Initial state — before iterative postorder construction begins */
...
/** Mid-construction — iterative progress through postorder sequence */
