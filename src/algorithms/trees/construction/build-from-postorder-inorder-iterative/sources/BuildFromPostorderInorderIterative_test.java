// javac *.java && java -ea BuildFromPostorderInorderIterative_test
import java.util.*;

public class BuildFromPostorderInorderIterative_test {
    ...
    public static void main(String[] args) {
        BuildFromPostorderInorderIterative algo = new BuildFromPostorderInorderIterative();

        // test: builds balanced 7-node BST
        TreeNode root1 = algo.buildFromPostorderInorderIterative(
        ...
        TreeNode root2 = algo.buildFromPostorderInorderIterative(
            new int[]{1, 3, 2, 5, 7, 6, 4}, new int[]{1, 2, 3, 4, 5, 6, 7});
        assert Arrays.equals(postorder(root2), new int[]{1, 3, 2, 5, 7, 6, 4}) : "Postorder should match";

        // test: returns null for empty
        assert algo.buildFromPostorderInorderIterative(new int[]{}, new int[]{}) == null : "Empty should return null";

        // test: single node
        TreeNode root3 = algo.buildFromPostorderInorderIterative(new int[]{7}, new int[]{7});
        assert root3.value == 7 : "Single node value should be 7";
