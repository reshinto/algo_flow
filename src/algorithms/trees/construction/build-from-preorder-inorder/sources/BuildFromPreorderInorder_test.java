// javac *.java && java -ea BuildFromPreorderInorder_test
import java.util.*;

public class BuildFromPreorderInorder_test {
    ...
    public static void main(String[] args) {
        BuildFromPreorderInorder algo = new BuildFromPreorderInorder();

        // test: builds balanced 7-node BST
        TreeNode root1 = algo.buildFromPreorderInorder(
        ...
        TreeNode root2 = algo.buildFromPreorderInorder(
            new int[]{4, 2, 1, 3, 6, 5, 7}, new int[]{1, 2, 3, 4, 5, 6, 7});
        assert Arrays.equals(preorder(root2), new int[]{4, 2, 1, 3, 6, 5, 7}) : "Preorder should match";

        // test: returns null for empty
        assert algo.buildFromPreorderInorder(new int[]{}, new int[]{}) == null : "Empty should return null";

        // test: single node
        TreeNode root3 = algo.buildFromPreorderInorder(new int[]{42}, new int[]{42});
        ...
        TreeNode root4 = algo.buildFromPreorderInorder(new int[]{1, 2, 3}, new int[]{1, 2, 3});
        assert root4.value == 1 && root4.left == null : "Right-skewed root should have no left child";
