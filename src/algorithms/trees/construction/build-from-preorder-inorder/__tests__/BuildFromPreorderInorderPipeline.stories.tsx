/**
 * Storybook stories for the Build Tree from Preorder + Inorder algorithm pipeline.
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Build Tree: Preorder + Inorder",
...
/** Mid-construction with some nodes built */
