/**
 * Storybook pipeline stories for Is Balanced Tree.
 */
...
const steps = generateIsBalancedTreeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Is Balanced Tree",
