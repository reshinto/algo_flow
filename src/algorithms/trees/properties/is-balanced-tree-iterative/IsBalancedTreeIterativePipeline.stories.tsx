/**
 * Storybook pipeline stories for Is Balanced Tree Iterative.
 */
...
const steps = generateIsBalancedTreeIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Is Balanced Tree Iterative",
