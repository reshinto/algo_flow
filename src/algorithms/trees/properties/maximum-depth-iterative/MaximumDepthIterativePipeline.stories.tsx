/**
 * Storybook pipeline stories for Maximum Depth Iterative.
 */
...
const steps = generateMaximumDepthIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Maximum Depth Iterative",
