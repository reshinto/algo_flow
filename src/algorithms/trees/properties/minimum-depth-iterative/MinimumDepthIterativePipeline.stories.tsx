/**
 * Storybook pipeline stories for Minimum Depth Iterative.
 */
...
const steps = generateMinimumDepthIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Minimum Depth Iterative",
