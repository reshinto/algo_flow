/**
 * Storybook pipeline stories for Sum of Left Leaves.
 */
...
const steps = generateSumOfLeftLeavesSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Sum of Left Leaves",
