...
import { maximumDepthEducational } from "./educational";
...
function executeMaximumDepth(input: MaximumDepthInput): number {
  interface BSTNode {
    value: number;
    left: BSTNode | null;
    right: BSTNode | null;
  ...
  return maximumDepth(toBSTNode(input.rootId)) as number;
}

const maximumDepthDefinition: AlgorithmDefinition<MaximumDepthInput> = {
  meta: {
    id: ALGORITHM_ID.MAXIMUM_DEPTH!,
    name: "Maximum Depth",
