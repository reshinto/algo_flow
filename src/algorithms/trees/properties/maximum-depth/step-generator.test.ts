...
describe("generateMaximumDepthSteps", () => {
  it("produces steps for a 7-node BST", () => {
    const steps = generateMaximumDepthSteps({ nodes: defaultNodes, rootId: "n4" });
  ...
  it("records result of 3 for a balanced 3-level tree", () => {
    const steps = generateMaximumDepthSteps({ nodes: defaultNodes, rootId: "n4" });
