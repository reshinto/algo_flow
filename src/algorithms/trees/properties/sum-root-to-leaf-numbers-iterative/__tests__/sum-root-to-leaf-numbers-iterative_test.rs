include!("../sources/sum-root-to-leaf-numbers-iterative.rs");
...
mod tests {
    ...
    fn test_7_node_bst() {
        ...
        assert_eq!(sum_root_to_leaf_numbers_iterative(root), 1776);
    }

    #[test]
    fn test_null_root() {
        assert_eq!(sum_root_to_leaf_numbers_iterative(None), 0);
    }

    #[test]
    fn test_single_node() {
        assert_eq!(sum_root_to_leaf_numbers_iterative(leaf(5)), 5);
    }
    ...
    fn test_simple_3_node_tree() {
        ...
        assert_eq!(sum_root_to_leaf_numbers_iterative(root), 25);
    }
}
