/**
 * Storybook pipeline stories for Maximum Path Sum.
 */
...
const steps = generateMaximumPathSumSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Maximum Path Sum",
