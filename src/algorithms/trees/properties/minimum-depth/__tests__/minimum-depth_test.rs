include!("../sources/minimum-depth.rs");
...
mod tests {
    ...
    fn test_balanced_7_node_bst() {
        ...
        assert_eq!(minimum_depth(root), 3);
    }

    #[test]
    fn test_null_root() {
        assert_eq!(minimum_depth(None), 0);
    }

    #[test]
    fn test_single_node() {
        assert_eq!(minimum_depth(leaf(42)), 1);
    }

    #[test]
    fn test_single_child_not_leaf() {
    ...
    fn test_two_level_tree() {
        ...
        assert_eq!(minimum_depth(root), 2);
    }
}
