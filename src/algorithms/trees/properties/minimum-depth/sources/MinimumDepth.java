...
class MinimumDepthNode {
    int value;
    MinimumDepthNode left, right;
    MinimumDepthNode(int value) { this.value = value; }
}

class MinimumDepth {
    public int minimumDepth(MinimumDepthNode root) {
        ...
        if (root.right == null && root.left != null) { // @step:visit
