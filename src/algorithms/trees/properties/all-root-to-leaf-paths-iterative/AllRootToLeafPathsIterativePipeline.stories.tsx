/**
 * Storybook pipeline stories for All Root to Leaf Paths Iterative.
 */
...
const steps = generateAllRootToLeafPathsIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/All Root to Leaf Paths Iterative",
