include!("sources/sum-of-left-leaves-iterative.rs");
...
mod tests {
    ...
    fn test_7_node_bst() {
        ...
        assert_eq!(sum_of_left_leaves_iterative(root), 6);
    }

    #[test]
    fn test_null_root() {
        assert_eq!(sum_of_left_leaves_iterative(None), 0);
    }

    #[test]
    fn test_single_node() {
        assert_eq!(sum_of_left_leaves_iterative(leaf(1)), 0);
    }

    #[test]
    fn test_left_leaf() {
        let root = make_node(1, leaf(5), None);
        assert_eq!(sum_of_left_leaves_iterative(root), 5);
    }
}
