/**
 * Storybook pipeline stories for Sum Root to Leaf Numbers.
 */
...
const steps = generateSumRootToLeafNumbersSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Sum Root to Leaf Numbers",
