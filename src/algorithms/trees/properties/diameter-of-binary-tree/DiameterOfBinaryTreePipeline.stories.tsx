/**
 * Storybook pipeline stories for Diameter of Binary Tree.
 */
...
const steps = generateDiameterOfBinaryTreeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Diameter of Binary Tree",
