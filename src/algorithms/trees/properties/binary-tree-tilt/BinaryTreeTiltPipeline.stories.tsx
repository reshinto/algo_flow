/**
 * Storybook pipeline stories for Binary Tree Tilt.
 */
...
const steps = generateBinaryTreeTiltSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Binary Tree Tilt",
