/**
 * Storybook pipeline stories for Path Sum Iterative.
 */
...
const steps = generatePathSumIterativeSteps({ nodes: defaultNodes, rootId: "n4", targetSum: 7 });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Path Sum Iterative",
