// javac *.java && java -ea InvertBinaryTree_test
import java.util.*;
...
public class InvertBinaryTree_test {
    ...
    public static void main(String[] args) {
        ...
        assert algo.invertBinaryTree(null) == null : "Null should return null";

        // test: single node
        BinaryNode single = leaf(1);
        BinaryNode result1 = algo.invertBinaryTree(single);
        ...
        BinaryNode result2 = algo.invertBinaryTree(tree1);
        ...
        BinaryNode result3 = algo.invertBinaryTree(tree2);
