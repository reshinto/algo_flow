/**
 * Storybook stories for the Invert Binary Tree algorithm pipeline.
 * Uses the real step generator with a balanced 7-node BST,
 * rendering the TreeVisualizer at key manipulation states.
 */
...
const steps = generateInvertBinaryTreeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Invert Binary Tree",
...
/** Initial state — tree shown before inversion begins */
...
/** Mid-manipulation with some nodes swapped */
...
/** Manipulation complete — tree fully inverted */
