/**
 * Storybook stories for the Delete Leaves With Value algorithm pipeline.
 * Uses the real step generator with a 7-node BST and target value 1,
 * rendering the TreeVisualizer at key post-order deletion states.
 */
...
const steps = generateDeleteLeavesWithValueSteps({
  nodes: defaultNodes,
  rootId: "n4",
  targetValue: 1,
});
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Delete Leaves With Value",
...
/** Initial state — tree before post-order deletion begins (target=1) */
...
/** Mid-manipulation with some leaves checked or deleted */
...
/** Manipulation complete — all matching leaves removed */
