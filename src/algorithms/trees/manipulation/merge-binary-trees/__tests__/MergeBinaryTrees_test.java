// javac *.java && java -ea MergeBinaryTrees_test
public class MergeBinaryTrees_test {
    ...
    public static void main(String[] args) {
        MergeBinaryTrees algo = new MergeBinaryTrees();

        // test: tree A null returns tree B
        BinaryNode treeB = leaf(1);
        assert algo.mergeBinaryTrees(null, treeB) == treeB : "Null A should return B";

        // test: tree B null returns tree A
        BinaryNode treeA = leaf(1);
        assert algo.mergeBinaryTrees(treeA, null) == treeA : "Null B should return A";

        // test: sums two single nodes
        BinaryNode result1 = algo.mergeBinaryTrees(leaf(3), leaf(5));
        ...
        BinaryNode result2 = algo.mergeBinaryTrees(a7, b7);
