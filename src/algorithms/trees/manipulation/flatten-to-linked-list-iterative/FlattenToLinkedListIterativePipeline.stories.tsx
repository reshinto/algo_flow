/**
 * Storybook stories for the Flatten Binary Tree to Linked List Iterative algorithm pipeline.
 * Uses the real step generator with a balanced 7-node BST,
 * rendering the TreeVisualizer at key Morris-like flattening states.
 */
...
const steps = generateFlattenToLinkedListIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Flatten to Linked List Iterative",
...
/** Initial state — tree shown before iterative flattening begins */
...
/** Mid-manipulation with some nodes rewired using Morris-like predecessor threading */
...
/** Manipulation complete — tree fully flattened iteratively to a right-skewed linked list */
