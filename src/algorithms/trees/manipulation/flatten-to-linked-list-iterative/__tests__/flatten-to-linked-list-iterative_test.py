...
module = importlib.import_module("flatten-to-linked-list-iterative")
BinaryNode = module.BinaryNode
flatten_to_linked_list_iterative = module.flatten_to_linked_list_iterative
...
def test_null_root_does_not_throw():
    flatten_to_linked_list_iterative(None)


def test_single_node_unchanged():
    root = make_node(1)
    flatten_to_linked_list_iterative(root)
