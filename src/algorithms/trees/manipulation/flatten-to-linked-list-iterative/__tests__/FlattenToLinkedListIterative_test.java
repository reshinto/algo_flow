// javac *.java && java -ea FlattenToLinkedListIterative_test
import java.util.*;

public class FlattenToLinkedListIterative_test {
    ...
    public static void main(String[] args) {
        FlattenToLinkedListIterative algo = new FlattenToLinkedListIterative();

        // test: single node unchanged
        BinaryNode single = leaf(1);
        algo.flattenToLinkedListIterative(single);
        ...
        algo.flattenToLinkedListIterative(tree1);
        ...
        algo.flattenToLinkedListIterative(tree2);
