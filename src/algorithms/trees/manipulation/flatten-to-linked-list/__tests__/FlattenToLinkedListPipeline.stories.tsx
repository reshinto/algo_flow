/**
 * Storybook stories for the Flatten Binary Tree to Linked List algorithm pipeline.
 * Uses the real step generator with a balanced 7-node BST,
 * rendering the TreeVisualizer at key flattening states.
 */
...
const steps = generateFlattenToLinkedListSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Flatten to Linked List",
...
/** Initial state — tree shown before flattening begins */
...
/** Mid-manipulation with some nodes rewired to the right */
...
/** Manipulation complete — tree fully flattened to a right-skewed linked list */
