include!("sources/invert-binary-tree-iterative.rs");
...
mod tests {
    ...
    fn test_null_returns_none() {
        assert!(invert_binary_tree_iterative(None).is_none());
    }

    #[test]
    fn test_single_node() {
        let result = invert_binary_tree_iterative(leaf(1));
    ...
    fn test_inverts_7_node_bst() {
        ...
        let result = invert_binary_tree_iterative(root);
