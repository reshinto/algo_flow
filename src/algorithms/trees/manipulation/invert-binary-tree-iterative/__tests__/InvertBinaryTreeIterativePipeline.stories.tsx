/**
 * Storybook stories for the Invert Binary Tree Iterative algorithm pipeline.
 * Uses the real step generator with a balanced 7-node BST,
 * rendering the TreeVisualizer at key BFS-level manipulation states.
 */
...
const steps = generateInvertBinaryTreeIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Invert Binary Tree Iterative",
...
/** Initial state — tree shown before BFS inversion begins */
...
/** Mid-manipulation with some levels swapped via BFS */
...
/** Manipulation complete — tree fully inverted iteratively */
