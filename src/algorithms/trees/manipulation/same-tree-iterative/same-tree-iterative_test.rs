include!("sources/same-tree-iterative.rs");
...
mod tests {
    ...
    fn test_two_null_trees() {
        assert_eq!(same_tree_iterative(&None, &None), true);
    }

    #[test]
    fn test_one_null_tree() {
        assert_eq!(same_tree_iterative(&leaf(1), &None), false);
    }

    #[test]
    fn test_identical_single_nodes() {
        assert_eq!(same_tree_iterative(&leaf(1), &leaf(1)), true);
    }

    #[test]
    fn test_different_single_nodes() {
        assert_eq!(same_tree_iterative(&leaf(1), &leaf(2)), false);
    }
    ...
    fn test_identical_7_node_bsts() {
        ...
        assert_eq!(same_tree_iterative(&tree_a, &tree_b), true);
    }
