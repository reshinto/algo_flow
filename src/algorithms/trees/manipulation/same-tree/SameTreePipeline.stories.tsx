/**
 * Storybook stories for the Same Tree algorithm pipeline.
...
const steps = generateSameTreeSteps({
  nodes: treeANodes,
  rootId: "n4",
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Same Tree",
...
/** Initial state — both trees before comparison begins */
...
/** Mid-manipulation with some node pairs compared */
...
/** Manipulation complete — all nodes compared, result determined */
