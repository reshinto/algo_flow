...
import { rightSideViewRecursiveEducational } from "./educational";
...
function executeRightSideViewRecursive(input: RightSideViewRecursiveInput): number[] {
  ...
  return rightSideViewRecursive(root) as number[];
}

const rightSideViewRecursiveDefinition: AlgorithmDefinition<RightSideViewRecursiveInput> = {
  meta: {
    id: ALGORITHM_ID.RIGHT_SIDE_VIEW_RECURSIVE!,
    name: "Right Side View (Recursive)",
