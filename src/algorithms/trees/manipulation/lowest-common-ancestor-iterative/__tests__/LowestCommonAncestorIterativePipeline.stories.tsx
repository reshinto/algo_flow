/**
 * Storybook stories for the Lowest Common Ancestor Iterative algorithm pipeline.
 * Uses the real step generator with a 7-node BST and targets 1 and 3,
 * rendering the TreeVisualizer at key BFS parent-map and ancestor-trace states.
 */
...
const steps = generateLowestCommonAncestorIterativeSteps({
  nodes: defaultNodes,
  rootId: "n4",
  nodeValueA: 1,
  nodeValueB: 3,
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Lowest Common Ancestor Iterative",
...
/** Initial state — tree before BFS parent-map construction begins */
...
/** Mid-manipulation during BFS parent-map phase */
...
/** Manipulation complete — LCA found via ancestor chain tracing */
