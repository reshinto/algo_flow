/**
 * Storybook stories for the Right Side View algorithm pipeline.
 * Uses the real step generator with a balanced 7-node BST,
 * rendering the TreeVisualizer at key BFS level-collection states.
 */
...
const steps = generateRightSideViewSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Right Side View",
...
/** Initial state — tree before BFS traversal begins */
...
/** Mid-manipulation with some levels processed and rightmost nodes collected */
...
/** Manipulation complete — all rightmost nodes collected */
