...
import { rightSideView } from "./sources/right-side-view.ts?fn";
import { generateRightSideViewSteps } from "./step-generator";
import type { RightSideViewInput } from "./step-generator";
import { rightSideViewEducational } from "./educational";
...
function executeRightSideView(input: RightSideViewInput): number[] {
  ...
  return rightSideView(root) as number[];
}

const rightSideViewDefinition: AlgorithmDefinition<RightSideViewInput> = {
  meta: {
    id: ALGORITHM_ID.RIGHT_SIDE_VIEW!,
