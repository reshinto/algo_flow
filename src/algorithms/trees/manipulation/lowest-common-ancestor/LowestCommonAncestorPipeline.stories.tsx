/**
 * Storybook stories for the Lowest Common Ancestor algorithm pipeline.
 * Uses the real step generator with a 7-node BST and targets 1 and 3,
 * rendering the TreeVisualizer at key search states.
 */
...
const steps = generateLowestCommonAncestorSteps({
  nodes: defaultNodes,
  rootId: "n4",
  nodeValueA: 1,
  nodeValueB: 3,
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Lowest Common Ancestor",
...
/** Initial state — tree before LCA search begins (targets: 1 and 3) */
...
/** Mid-manipulation with some nodes visited during post-order search */
...
/** Manipulation complete — LCA node identified */
