...
import { bstValidationEducational } from "./educational";
...
function executeBstValidation(input: BstValidationInput): boolean {
  ...
  return bstValidation(root) as boolean;
}

const bstValidationDefinition: AlgorithmDefinition<BstValidationInput> = {
  meta: {
    id: ALGORITHM_ID.BST_VALIDATION!,
    name: "BST Validation (Recursive)",
