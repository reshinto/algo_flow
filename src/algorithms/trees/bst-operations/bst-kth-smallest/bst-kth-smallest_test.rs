include!("sources/bst-kth-smallest.rs");
...
mod tests {
    ...
    fn test_first_smallest() {
        assert_eq!(bst_kth_smallest(&build_tree(), 1), 1);
    }

    #[test]
    fn test_third_smallest() {
        assert_eq!(bst_kth_smallest(&build_tree(), 3), 3);
    }

    #[test]
    fn test_seventh_smallest() {
        assert_eq!(bst_kth_smallest(&build_tree(), 7), 7);
    }

    #[test]
    fn test_fourth_smallest() {
        assert_eq!(bst_kth_smallest(&build_tree(), 4), 4);
    }

    #[test]
    fn test_out_of_range() {
        assert_eq!(bst_kth_smallest(&build_tree(), 10), -1);
    }
}
