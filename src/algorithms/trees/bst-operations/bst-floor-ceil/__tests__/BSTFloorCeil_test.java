...
public class BSTFloorCeil_test {
    ...
    // int[] result: [0]=floor (Integer.MIN_VALUE = null), [1]=ceil (Integer.MAX_VALUE = null)
    static final int FLOOR_NULL = Integer.MIN_VALUE;
    static final int CEIL_NULL = Integer.MAX_VALUE;
    ...
    public static void main(String[] args) {
        ...
        assert result2[0] == FLOOR_NULL : "Floor should be null for 0";
        ...
        assert result3[1] == CEIL_NULL : "Ceil should be null for 8";

        // test: null tree
        int[] result4 = bfc.bstFloorCeil(null, 5);
        assert result4[0] == FLOOR_NULL : "Floor should be null for null tree";
        assert result4[1] == CEIL_NULL : "Ceil should be null for null tree";
