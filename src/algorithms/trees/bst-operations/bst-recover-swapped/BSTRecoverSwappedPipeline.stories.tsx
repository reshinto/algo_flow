...
/** BST with nodes 3 and 7 swapped — demonstrates the recovery algorithm */
...
const steps = generateBstRecoverSwappedSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST Recover Swapped Nodes",
