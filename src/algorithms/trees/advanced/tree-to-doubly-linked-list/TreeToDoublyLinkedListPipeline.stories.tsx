/**
 * Storybook pipeline stories for BST to Doubly Linked List.
 */
...
const steps = generateTreeToDoublyLinkedListSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Tree to Doubly Linked List",
...
/** Initial state — BST before conversion */
export const InitialState: Story = {
  args: { visualState: steps[0]!.visualState as TreeVisualState },
};

/** Mid-operation — partial DLL formed */
...
/** Operation complete — full circular DLL */
