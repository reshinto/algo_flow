/**
 * Storybook stories for the Morris In-Order Traversal algorithm pipeline.
...
const steps = generateMorrisInorderTraversalSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Morris In-Order Traversal",
...
/** Initial state — tree shown before threading begins */
...
/** Mid-traversal — threading in progress, some nodes visited */
...
/** Completed traversal — all nodes visited in sorted order, tree restored */
