/**
 * Storybook stories for the BST Pre-Order Traversal (Iterative) algorithm pipeline.
...
const steps = generateBstPreorderIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST Pre-Order (Iterative)",
...
/** Completed traversal — all nodes visited in pre-order */
