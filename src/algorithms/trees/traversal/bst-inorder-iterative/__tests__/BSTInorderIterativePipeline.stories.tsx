/**
 * Storybook stories for the BST In-Order Traversal (Iterative) algorithm pipeline.
...
const steps = generateBstInorderIterativeSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST In-Order (Iterative)",
