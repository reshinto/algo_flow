/**
 * Storybook stories for the Level-Order Traversal algorithm pipeline.
...
const steps = generateLevelOrderTraversalSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Level-Order Traversal",
...
/** Mid-traversal — second level being processed */
...
/** Completed traversal — all levels visited */
