/**
 * Storybook stories for the BST Post-Order Traversal algorithm pipeline.
...
const steps = generateBstPostorderSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST Post-Order",
...
/** Completed traversal — all nodes visited in post-order, root last */
