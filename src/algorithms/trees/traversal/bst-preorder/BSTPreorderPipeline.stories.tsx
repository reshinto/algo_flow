/**
 * Storybook stories for the BST Pre-Order Traversal algorithm pipeline.
...
const steps = generateBstPreorderSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST Pre-Order",
