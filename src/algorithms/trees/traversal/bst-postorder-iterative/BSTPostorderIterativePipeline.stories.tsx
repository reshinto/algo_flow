/**
 * Storybook stories for the BST Post-Order Traversal (Iterative) algorithm pipeline.
...
const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST Post-Order (Iterative)",
...
/** Mid-traversal — phase 1 building stack 2 */
...
/** Completed traversal — all nodes visited in post-order */
