/**
 * Storybook stories for the Vertical-Order Traversal algorithm pipeline.
...
const steps = generateVerticalOrderTraversalSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Vertical-Order Traversal",
...
/** Mid-traversal — BFS assigning column indices */
...
/** Completed traversal — all nodes visited by column */
