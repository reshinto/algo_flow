/**
 * Storybook stories for the Boundary Traversal algorithm pipeline.
...
const steps = generateBoundaryTraversalSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Boundary Traversal",
...
/** Mid-traversal — visiting leaf nodes along the bottom */
...
/** Completed traversal — full boundary visited counterclockwise */
