/**
 * Storybook stories for the Zigzag Level-Order Traversal algorithm pipeline.
...
const steps = generateZigzagLevelOrderSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/Zigzag Level-Order",
...
/** Mid-traversal — second level being processed in reverse */
...
/** Completed traversal — all levels visited in zigzag pattern */
