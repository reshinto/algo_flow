...
import rustSource from "./sources/best-time-buy-sell.rs?raw";
import cppSource from "./sources/BestTimeBuySell.cpp?raw";
import goSource from "./sources/best-time-buy-sell.go?raw";
