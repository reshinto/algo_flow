/**
 * Storybook stories for the Kruskal's algorithm pipeline.
 * Uses the real step generator with a 6-node weighted undirected graph,
 * rendering the GraphVisualizer at key MST construction states.
 */
...
const steps = generateKruskalsSteps({
  edges,
  nodeIds: ["A", "B", "C", "D", "E", "F"],
  nodes,
  graphEdges,
...
const meta: Meta<typeof GraphVisualizer> = {
  title: "Algorithm Pipelines/Kruskal's",
...
/** Initial state — all nodes isolated, no MST edges yet */
...
/** Mid-execution — some edges accepted into MST, some rejected as cycles */
...
/** Execution complete — full MST spanning all 6 nodes with minimum total weight */
