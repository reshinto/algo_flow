/**
 * Storybook stories for the Edmonds-Karp algorithm pipeline.
...
const adjacencyList: EdmondsKarpInput["adjacencyList"] = {
  S: [
...
const steps = generateEdmondsKarpSteps({
  adjacencyList,
  sourceNodeId: "S",
  sinkNodeId: "T",
  nodes,
...
const meta: Meta<typeof GraphVisualizer> = {
  title: "Algorithm Pipelines/Edmonds-Karp",
...
/** Initial state — flow network before any BFS augmentation */
...
/** Mid-execution — BFS found a shortest augmenting path, flow being pushed */
...
/** Execution complete — max flow reached via BFS shortest paths */
