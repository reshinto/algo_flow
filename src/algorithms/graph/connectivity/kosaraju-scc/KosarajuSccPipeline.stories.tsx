/**
 * Storybook stories for the Kosaraju's SCC algorithm pipeline.
...
const steps = generateKosarajuSccSteps({
  adjacencyList: {
    A: ["B"],
    B: ["C"],
    C: ["A", "D"],
...
const meta: Meta<typeof GraphVisualizer> = {
  title: "Algorithm Pipelines/Kosaraju SCC",
...
/** Initial state — all nodes unvisited, finish-order stack empty */
...
/** Mid-execution — first DFS pass complete, second pass in progress */
