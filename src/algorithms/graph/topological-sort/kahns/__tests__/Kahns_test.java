...
// Compile: javac Kahns.java Kahns_test.java
// Run:     java -ea Kahns_test
public class Kahns_test {
    public static void main(String[] args) {
        ...
        testHandlesMultipleZeroInDegreeNodes();
        testReturnsAllNodesForFullyIndependentNodeSet();
        testProducesFewerResultsWhenCycleExists();
    ...
    static void testProducesValidTopologicalOrderForDefaultDag() {
        ...
        List<String> result = Kahns.kahnsTopologicalSort(adj, Arrays.asList("A","B","C","D","E","F"));
    ...
    static void testPlacesSourceNodeFirstInLinearChain() {
        ...
        List<String> result = Kahns.kahnsTopologicalSort(adj, Arrays.asList("A","B","C","D"));
    ...
    static void testHandlesSingleNodeWithNoEdges() {
        ...
        List<String> result = Kahns.kahnsTopologicalSort(adj, Arrays.asList("A"));
        assert result.equals(Arrays.asList("A"));
    }

    static void testHandlesMultipleZeroInDegreeNodes() {
        Map<String, List<String>> adj = new LinkedHashMap<>();
        adj.put("A", Arrays.asList("C")); adj.put("B", Arrays.asList("C")); adj.put("C", Collections.emptyList());
        List<String> result = Kahns.kahnsTopologicalSort(adj, Arrays.asList("A","B","C"));
