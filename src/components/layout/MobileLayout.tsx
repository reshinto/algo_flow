/**
 * Single-panel mobile layout (<768px) with a tab switcher.
 * Only the active panel is mounted to keep the viewport uncluttered.
 */
...
/** Tab-based layout for mobile viewports; renders one panel at a time. */
