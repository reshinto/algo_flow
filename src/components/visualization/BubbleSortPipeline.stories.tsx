/**
 * Storybook stories for the Bubble Sort algorithm pipeline.
...
import { generateBubbleSortSteps } from "@/algorithms/sorting/bubble-sort/step-generator";
import ArrayVisualizer from "./ArrayVisualizer";

const steps = generateBubbleSortSteps([64, 34, 25, 12, 22, 11, 90]);

const meta: Meta<typeof ArrayVisualizer> = {
  title: "Algorithm Pipelines/Bubble Sort",
