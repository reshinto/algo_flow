/**
 * Storybook stories for the BST In-Order Traversal algorithm pipeline.
...
import { generateBstInorderSteps } from "@/algorithms/trees/bst-inorder/step-generator";
...
const steps = generateBstInorderSteps({ nodes: defaultNodes, rootId: "n4" });

const meta: Meta<typeof TreeVisualizer> = {
  title: "Algorithm Pipelines/BST In-Order",
...
/** Mid-traversal with some nodes visited */
...
/** Completed traversal — all nodes visited in sorted order */
