...
- **453 Algorithms across 14 Categories** with interactive visualizations (bar charts, SVG graphs/trees, CSS grids, DP tables, and more)
...
| Browse all 453 algorithms          | 🔍 [Algorithm Catalog](docs/algorithms-catalog.md)                |
